...
def generate(stats_json: str) -> bytes:
    ...
    # ── RESUMEN (solo con las secciones seleccionadas) ────────────────────────
    ws = wb.active
    ws.title = "Resumen"
    ...
    # Construir sections solo con las secciones presentes
    sections = []
    if pacientes is not None:
        sections.append(("PACIENTES", LIGHT_BLUE, [
    ...
    if citas is not None:
        sections.append(("CITAS", LIGHT_GREEN, [
    ...
    if visitas is not None:
        sections.append(("VISITAS E INGRESOS", LIGHT_AMBER, [
    ...
    if membresias is not None:
        sections.append(("MEMBRESÍAS", LIGHT_BLUE, [
    ...
    if medicinas is not None:
        sections.append(("INVENTARIO — MEDICINAS", LIGHT_GREEN, [
    ...
    if equipo is not None:
        sections.append(("INVENTARIO — EQUIPO MÉDICO", LIGHT_AMBER, [
    ...
    if notificaciones is not None:
        sections.append(("NOTIFICACIONES", LIGHT_RED, [
    ...
    # ── SERVICIOS POR MES ─────────────────────────────────────────────────────
    if visitas is not None or servicios is not None:
    ...
    # ── INVENTARIO ────────────────────────────────────────────────────────────
    if medicinas is not None or equipo is not None:
